...
int Mesh::MakeTri(glm::vec4 positon0, glm::vec4 positon1, glm::vec4 positon2, Vertex vertices[], int count)
{
	...
	glm::vec3 a = positon1 - positon0;
	glm::vec3 b = positon2 - positon0;
	glm::vec4 newNormal = { a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x, 0 };
	vertices[startCount + 0].normal = newNormal;
	vertices[startCount + 1].normal = newNormal;
	vertices[startCount + 2].normal = newNormal;
